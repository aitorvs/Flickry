...
/**
 * Based on <a href="https://github.com/facebook/stetho">StethoInterceptor</a>
 * Modified to allow using it also in application interceptors like so:
 * <pre>
...
public class StethoInterceptor implements Interceptor {
    ...
    private static class OkHttpInspectorResponse implements NetworkEventReporter.InspectorResponse {
        ...
        public int connectionId() {
            // maybe we use it in an application interceptor
            return mConnection == null ? -1 : mConnection.hashCode();
        }
